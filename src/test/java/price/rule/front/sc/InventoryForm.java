...
public class InventoryForm
{
    ...
    @FindBy(xpath="//input[@id='SearchKeyword']") WebElement SearchField;
	
	@FindBy(xpath="//button[contains(@onclick,'doSearch')]") WebElement SubmitButton;
	
	@FindBy(xpath="//button[@type='button' and contains(text(),'Soit')][1]") WebElement PrDropdown;
